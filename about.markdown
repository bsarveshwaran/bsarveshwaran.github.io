...
I can contribute to forward-thinking organizations that value adaptability, collaboration, and continuous improvement. I’m passionate about using technology to solve real-world problems and excited to bring my diverse skill set to teams focused on growth and excellence.

Let’s connect if you're looking for someone who can wear multiple hats and deliver measurable value across business and technology domains. I am not starting from zero. I am repositioning myself from “Quality Assurance of Software” to “Quality Assurance & Interpretation of Data-Driven decisions.”
